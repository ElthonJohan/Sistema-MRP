...
.obra-mat-name { font-size: .88rem; font-weight: 800; color: #f1f5f9; }
.obra-mat-unit { font-size: .70rem; color: rgba(148,163,184,.50); margin-top: .08rem; }
.obra-mat-stock {
...
.obra-mat-stock-lbl {
    ...
    letter-spacing: .07em; color: rgba(148,163,184,.45); margin-top: .12rem;
}
...
<div style="background:linear-gradient(135deg,rgba(13,148,136,.15),rgba(5,150,105,.06));
  ...
  <div style="font-size:.68rem;color:rgba(148,163,184,.40);margin-top:.2rem">stock total en {sel_name}</div>
